...
- **Canonical selected size:** **73 Story Points**. This total counts #183–#195 once, adds the concrete frontend PBIs #201, #202, #203, and #206, excludes duplicate planning issue #182, and does not add #204 separately because it is the concrete cost-fix item represented by the five-point maintenance task #184.

**Live metadata gap (audited 2026-07-18):** milestone 9 currently contains #182–#195, while #201, #202, #203, #204, and #206 still lack the milestone because GitHub write authentication was unavailable during this update. The Project contains only 13 older Assignment 4 items, and its existing view named `Sprint 5 Backlog` still filters `Sprint 5 — MVP v2`. Until those GitHub metadata corrections are applied, the milestone and Project do not yet reflect the refined canonical scope below.
...
- **Planning:** [#183](https://github.com/Team-9-swp/Route-optimization-Platform-swp/issues/183) is the canonical planning task. The roadmap and issue audit are updated, but the Project criterion remains blocked until the stale Sprint 5 view is corrected and milestone issues are added to the Project.
- **Maintenance and verification:** [#184](https://github.com/Team-9-swp/Route-optimization-Platform-swp/issues/184), [#185](https://github.com/Team-9-swp/Route-optimization-Platform-swp/issues/185), and the concrete cost-fix PBI [#204](https://github.com/Team-9-swp/Route-optimization-Platform-swp/issues/204) remain open.
