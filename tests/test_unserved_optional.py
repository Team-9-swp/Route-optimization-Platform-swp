...
async def test_unserved_optional_present_after_solve(repository):
    instance = {
        ...
        "orders": [
            {"id": 1, "x": 1, "y": 0, "volume": 10, "loader_cnt": 1,
             "time_window": [0, 100], "vehicle_service_time": 5,
             "loader_service_time": 5, "optional": 0},
            {"id": 2, "x": 2, "y": 0, "volume": 10, "loader_cnt": 1,
             "time_window": [0, 100], "vehicle_service_time": 5,
             "loader_service_time": 5, "optional": 1},
            {"id": 3, "x": 3, "y": 0, "volume": 10, "loader_cnt": 1,
             "time_window": [0, 100], "vehicle_service_time": 5,
             "loader_service_time": 5, "optional": 1},
        ],
        "weights": {"vehicle_salary": 100, "fuel_cost": 1,
                    "loader_salary": 50, "loader_work": 1,
