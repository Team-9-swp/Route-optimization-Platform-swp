...
- **Current published version:** [`v1.5.0`](https://github.com/Team-9-swp/Route-optimization-Platform-swp/releases/tag/v1.5.0) — final Assignment 6 / MVP v3 release from protected `main`.
- **Final course state:** The Assignment 6 / MVP v3 product state is packaged in `v1.5.0`; release tracking is recorded in [#190](https://github.com/Team-9-swp/Route-optimization-Platform-swp/issues/190).
...
Issue [#90](https://github.com/Team-9-swp/Route-optimization-Platform-swp/issues/90) remains the tracking item for deployment/customer access. The latest published release is [`v1.5.0`](https://github.com/Team-9-swp/Route-optimization-Platform-swp/releases/tag/v1.5.0); its packaging is recorded in [#190](https://github.com/Team-9-swp/Route-optimization-Platform-swp/issues/190).
